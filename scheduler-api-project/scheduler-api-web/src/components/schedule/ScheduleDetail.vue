    ...
    <div
      ...
      <div class="z-50 w-11/12 mx-auto overflow-y-auto bg-white rounded shadow-lg modal-container md:max-w-md">
        <div class="px-6 py-4 text-left modal-content">
          <h1 class="my-3">정말로 스케줄을 삭제하시겠습니까?</h1>
          <div class="flex justify-end pt-2">
            <button
              @click="deleteJob()"
              class="px-3 py-2 font-medium tracking-wide text-white bg-indigo-600 rounded-md hover:bg-indigo-500 focus:outline-none">
              삭제
            </button>
            <button
              @click="open = false"
              class="px-3 py-2 mx-2 text-indigo-500 bg-transparent rounded-lg hover:bg-gray-100 hover:text-indigo-400 focus:outline-none">
              취소
            </button>
          </div>
        </div>
